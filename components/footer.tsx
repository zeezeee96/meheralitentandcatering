      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <h3 className="text-3xl font-bold text-amber-300 mb-2">Meher Ali</h3>
              <p className="text-xl text-amber-100 mb-4">Tent & Pakwan Center</p>
              <p className="text-amber-100 leading-relaxed max-w-md">
                Complete catering and event solutions for all your special occasions. Serving Chakwal and surrounding
                areas with excellence since 2009.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-amber-100 text-sm">15+ Years of Excellence</span>
            </div>
          </div>

          {/* Quick Links */}
          <div className="space-y-6">
            <h4 className="text-xl font-semibold text-amber-300 border-b border-amber-300/30 pb-2">Quick Links</h4>
          ...
          {/* Contact Info */}
          <div className="space-y-6">
            <h4 className="text-xl font-semibold text-amber-300 border-b border-amber-300/30 pb-2">Contact Info</h4>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <MapPin className="w-5 h-5 text-amber-300 mt-1 flex-shrink-0" />
                <div>
                  <p className="text-amber-100 font-medium">Near 15 Yadgar Chowk</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-amber-100 font-medium">Daily: 8:00 AM - 10:00 PM</p>
                  <p className="text-amber-200 text-sm">24/7 Emergency Support</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-amber-300/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-amber-100 text-sm">© 2024 Meher Ali Tent and Pakwan Center. All rights reserved.</p>
