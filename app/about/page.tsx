...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      ...
      <section className="py-20 bg-gradient-to-r from-maroon-800 to-maroon-900 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-amber-100 max-w-3xl mx-auto">
            Your trusted partner for memorable events and exceptional catering services in Chakwal
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-maroon-800 mb-6">Our Story</h2>
              <div className="space-y-6 text-gray-700 leading-relaxed">
                <p className="text-lg">
                  Established near 15 Yadgar Chowk in Chakwal, Meher Ali Tent and Pakwan Center has been serving the
                  community for over 15 years with dedication, quality, and authentic Pakistani hospitality.
                </p>
                <p>
                  What started as a small family business has grown into one of Chakwal's most trusted catering
                  services. We understand that every event is special and unique, which is why we put our heart into
                  every detail, from the first consultation to the final cleanup.
                </p>
                <p>
                  Our commitment to excellence and customer satisfaction has made us the preferred choice for families
                  across Chakwal and surrounding areas for weddings, corporate events, religious ceremonies, and all
                  kinds of gatherings.
                </p>
              </div>
            </div>
      ...
      {/* Values Section */}
      <section className="py-20 bg-gradient-to-r from-amber-50 to-maroon-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-maroon-800 mb-12">Our Values</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                icon: Users,
                title: "Community",
                description: "Deeply rooted in Chakwal's community, we understand local traditions and preferences.",
              },
              {
                icon: Clock,
                title: "Reliability",
              ...
              >
                <CardContent className="pt-6">
                  <value.icon className="w-16 h-16 text-amber-600 mx-auto mb-4 group-hover:scale-110 group-hover:text-maroon-600 transition-all duration-300" />
          ...
          <Card className="p-8 bg-gradient-to-br from-amber-50 to-white border-0 shadow-xl hover:shadow-2xl transition-all duration-500">
            <CardContent className="pt-0">
              <p className="text-xl text-gray-700 leading-relaxed mb-6">
                "To create unforgettable experiences through exceptional catering and event services, bringing families
                and communities together with authentic Pakistani hospitality, delicious food, and meticulous attention
                to detail."
              </p>
              <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-maroon-500 mx-auto"></div>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      {/* Why Choose Us */}
      <section className="py-20 bg-gradient-to-br from-gray-900 via-maroon-900 to-gray-900 text-white">
        <div className="max-w-6xl mx-auto px-4">
            ...
            {[
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className="text-amber-100 leading-relaxed">{reason.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
